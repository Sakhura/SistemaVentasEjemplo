	...
	// Sentencias
		...
		public int realizarVenta(Cliente c, Boleta_Cabecera cabBoleta, ArrayList<Boleta_Detalle> detBoleta) {
			...
			try {
				 ...
				 *  un codigo nuevo. pero aunque el cliente ' c ' no exista para evitar a�adir mucho codigo, 
		...
		public int generarBoleta(Boleta_Cabecera_Reporte cabeza, ArrayList<Boleta_Detalle_Reporte> calzados, int tipoComprobante) {
			int respuesta = -1;
			/** existe otra manera, traer el .jrxml , pasarlo a un FileInputStream y recien compilarlo, aca usamos defrente la compilacion ".jasper"  **/
...
//				String comprobante_logo = "logo_reporte.png";
				...
				parametros.put("direccion_empresa","MUY MUY LEJANO ");
				parametros.put("COMUNA_empresa","CHILOE");
				parametros.put("telefono_empresa","942184912");
				parametros.put("web_empresa", "www.pepito.cl");
				...
				parametros.put("distrito_cliente", cabeza.getComuna_cliente());
				parametros.put("dni_cliente", cabeza.getRut_cliente());
				parametros.put("telefono_cliente", cabeza.getCelular_cliente());
